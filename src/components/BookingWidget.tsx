  ...
  return (
    <>
      <div className="flex justify-center items-center ">
        <div className="border-t-[#D7AB4E] border-l-[#D7AB4E] border-r-[#666666] border-b-[#666666] border-2 rounded-3xl lg:rounded-full bg-gradient-to-l from-[#303030] to-[#111111]  w-[95%] md:w-[60%] lg:w-[80%]  m-auto h-fit lg:h-32  p-0 lg:p-14 gap-5 flex flex-col lg:flex-row lg:items-center ">
          <div className="flex justify-center">
            <img className="w-28 h-20 mt-3  lg:h-28" src={logo} alt="Hsqlogo" />
          </div>

          <div className="flex gap-2 pl-2 lg:gap-7 sm:flex-row">
            <Datepicker
              title="Arrival"
              value={arrival}
            ...
            <div className="">
              ...
              <select
                ...
                className="w-28 text-black bg-white  mt-1 px-[2px] rounded-md lg:w-full lg:px-3 py-2 text-sm border-0 focus:outline-none focus:ring-2 focus:ring-yellow-500 h-10"
              >
          ...
          <div className="poppins-semibold relative lg:mt-5  flex justify-center w-full sm:w-fit items-center mb-5 lg:mb-0 ">
            ...
            <div className="absolute top-2 left-14 sm:left-3 bg-black rounded-full px-1 py-1">
